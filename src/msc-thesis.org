...
** Properties of the Star at the Disk Center
- age
- mass
- luminosity
- Kepler velocity
...
** Sound Speed
- sound speed
* Definition of a Model for Dust Particles
** Dust Particle Shape
** Dust Particle Stopping Time
** Reynolds & Stokes Number
* Definition of a Model for Dust Coagulation
...
\begin{figure}[h!]
    ...
    \end{minipage}
    \caption{
        Transformation between bin indices and mass values on a
        linearily scaled discretized mass axis.
    }
\end{figure}
...
\begin{figure}[h!]
    ...
    \caption{
        Transformation between bin indices and mass values on a
        logarithmically scaled discretized mass axis.
    }
\end{figure}
...
Equivalent formulation: [which one to use? I like the lower one]
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{../../msc-thesis.py/figures/21/collision_cross_section.pdf}
    \caption{CAPTION ...}
\end{figure}
\newpage
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{../../msc-thesis.py/figures/23/collision_rate.pdf}
    \caption{CAPTION ...}
\end{figure}
\newpage
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{../../msc-thesis.py/figures/13/dv_RD.pdf}
    \caption{CAPTION ...}
\end{figure}
\newpage
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{../../msc-thesis.py/figures/13/dv_DS.pdf}
    \caption{CAPTION ...}
\end{figure}
\newpage
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{../../msc-thesis.py/figures/13/dv_BR.pdf}
    \caption{CAPTION ...}
\end{figure}
\newpage
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{../../msc-thesis.py/figures/13/dv_TU.pdf}
    \caption{CAPTION ...}
\end{figure}
\newpage
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{../../msc-thesis.py/figures/13/dv_AZ.pdf}
    \caption{CAPTION ...}
\end{figure}
\newpage
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=\textwidth]{../../msc-thesis.py/figures/13/dv_tot.pdf}
    \caption{CAPTION ...}
\end{figure}
\newpage
...
g \cite{ormel_cuzzi_2007}
c \cite{brauer_dullemond_henning_2007}
d \cite{birnstiel_dullemond_brauer_2010}
e \cite{kovetz_olund_1969}
f \cite{smoluchowski_1916}
g \cite{stammler_birnstiel_2022}
