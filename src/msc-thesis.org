...
\begin{figure}[h!]
    ...
    \begin{minipage}{0.5\textwidth}
        ...
        \subcaption{
            Calculation of mass values from bin indices.
        }
    \end{minipage}%
    \begin{minipage}{0.5\textwidth}
        \centering
        ...
        \subcaption{
            Calculation of bin indices from mass values.
        }
    \end{minipage}
    \begin{minipage}{0.5\textwidth}
        \centering
        ...
        \subcaption{
            Roundtrip transformation: Bin index $\to$ mass value $\to$ bin index.
        }
    \end{minipage}%
    \begin{minipage}{0.5\textwidth}
        \centering
        ...
        \subcaption{
            Roundtrip transformation: Mass value $\to$ bin index $\to$ mass value.
        }
    \end{minipage}
    \caption{
